...
urlpatterns = [
    ...
    path('search-cars', views.searchCarView, name='search-cars'),
    path('aboutus', views.aboutusView, name='aboutus'),
    #path('client-contact', views.contactView, name='client-contact'),
    #path('api/random_cars/', views.random_cars, name='random_cars'),
